...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <a href="tambah_data_lokasi.php" class="btn btn-sm btn-primary">Tambah Data</a>
    <br> <br>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?= $rs['alamat']; ?></td>
                    <td>
                        <a href="ubah_lokasi.php?id=<?=$rs['id_lokasi']; ?>" class="btn btn-info btn-sm">Ubah</a>
                        <a href="hapus_data_lokasi.php?id=<?=$rs['id_lokasi']; ?>" class=" btn btn-danger btn-sm">Hapus</a>
                    </td>
                </tr>
            <?php
            $no++;
